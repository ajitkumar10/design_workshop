...
ReportConfig
	...
	.rptOutputDir()	
	.rptOutputFileNames("{report_type}_{report_sub_type}_{input_date(s)}.csv")  -- if multiple files, delivered in order specified
...
ReportScheduler
	...
	.dependsOn(job1, job2)  -- takes a list of predicates and tests them each time 
